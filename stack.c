...
language - c, c++
std::stack может быть инициализирован другим объектом stack или совместимыми контейнерами последовательностей, такими как deque,vector и list.
Однако  контейнер по умолчанию используемый для хранения элементов stack, - этоdeque
